...
export default class Ball {
    ...
    checkCollision(ball) {
        ...
        if (distance <= this.radius + ball.radius) {
            ...
            const a_normal_velocity = (a_normal_scalar * (this.radius - ball.radius) + 2 * ball.radius * b_normal_scalar) /
                (this.radius + ball.radius);
            const b_normal_velocity = (b_normal_scalar * (ball.radius - this.radius) + 2 * this.radius * a_normal_scalar) /
                (this.radius + ball.radius);
